...
- `crates/rusty-mcp`: 82 tools (2026-09-03: six of them the PIN and the reveal behind the
  Secrets tab since TICKET-015, five the brain loop since TICKET-018, four the store's
  scripts since TICKET-010, two the Obsidian vault import since TICKET-026), five resources plus templates, `list_changed` notifications,
