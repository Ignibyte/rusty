...
| `crates/rusty-mcp` | the back end: 67 tools, five resources, change notifications, a background indexer; stdio for agents, Streamable HTTP for the app | [MCP back end](mcp-back-end.md) |
